...
export const Reply = Schema.Literals(["once", "always", "reject", "manual_apply"])
...
export interface Interface {
  readonly ask: (input: AskInput) => Effect.Effect<Reply | void, Error>
...
interface PendingEntry {
  info: Request
  deferred: Deferred.Deferred<Reply | void, RejectedError | CorrectedError>
}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const ask = Effect.fn("Permission.ask")(function* (input: AskInput) {
      ...
      const deferred = yield* Deferred.make<Reply | void, RejectedError | CorrectedError>()
    ...
    const reply = Effect.fn("Permission.reply")(function* (input: ReplyInput) {
      ...
      yield* Deferred.succeed(existing.deferred, response === "manual_apply" ? response : undefined)
